...
The goal of regexciteamm is to make regular expressions more exciting!
It provides convenience functions to make some common tasks with string
manipulation and regular expressions a bit easier.

## Installation

You can install the development version of regexciteamm from
[GitHub](https://github.com/) with:

``` r
# install.packages("devtools")
devtools::install_github("jennybc/regexciteamm")
```
...
That’s exactly what `regexciteamm::str_split_one()` does.

``` r
library(regexciteamm)
